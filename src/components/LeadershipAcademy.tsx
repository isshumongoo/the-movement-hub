  ...
  <section>
    ...
    <div className="bg-white border rounded-xl shadow-md p-4 mb-3">
      ...
      <div className="mt-4 flex gap-2">
        <button className="px-4 py-1 bg-fuchsia-600 text-white rounded shadow hover:scale-105 transition">Resource Library</button>
        <button className="px-4 py-1 bg-blue-600 text-white rounded shadow hover:scale-105 transition">Submit Reflection</button>
      </div>
    </div>
  </section>
);
